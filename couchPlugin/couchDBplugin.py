    ...
    if hasattr(data, 'Medications'):
        ...
        for med in patient.Medications:
           if med.Name == data.Medications.Name:
               ...
               patient.store(db)
               stop = 'True'
               print "Edited Medication "  + med.Name + " with Dose " + med.Dose + med.Units + " with Route " + med.Route
        if stop == 'False':
            obj = {'Name': data.Medications.Name,
                   'Dose': data.Medications.Dose,
                   'Units': data.Medications.Units,
            ...
            patient.Medications.append(obj)
            patient.store(db)
            print "Added Medication " + data.Medications.Name + " with Dose " + data.Medications.Dose + data.Medications.Units + " with Route " + data.Medications.Route
